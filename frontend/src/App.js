...
import SmartImportModule from './components/erp/SmartImportModule';
...
function App() {
  ...
  const renderModule = () => {
    switch (currentModule) {
      ...
      case 'pdf-config': return <PDFConfigModule token={token} userRole={user?.role} hasPerm={hasPerm} />;
      case 'smart-import': return <SmartImportModule token={token} />;
